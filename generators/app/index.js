...
var SpringbootGenerator = module.exports = yeoman.generators.Base.extend({
    ...
    prompting: function () {
        ...
        var logo = "  _   _       ______ _____             \n" +
            ...
            "                                       \n";
        this.log(chalk.green(logo) + 'Welcome to the supreme ' + chalk.red('generator-FTD-springboot') + ' generator!' + '\n' + chalk.yellow('Usually the default prompt is recommended. '));
    ...
    writing: function () {
        ...
        var sampleDir = sourceDir + "com/FTD/sample/";
        var sampleDestDir = sourceDir + packageDir + "sample/";
        var sampleTestDir = testDir + "com/FTD/sample/";
        ...
        //app
        this.template(sourceDir + 'com/FTD/Application.groovy', sourceDir + packageDir + this.props.applicationName + ".groovy", this.props, {'interpolate': /<%=([\s\S]+?)%>/g});
